...
class Preprocess:
    ...
    # 클래스가 시작될때 __init__을 불러오는
    # 그래서 워드 인덱스랑 유저사전을 불러와서 
    def __init__(self, word2index_dic='D:/song/practice/project2/chatbot/train_tools/dict/chatbot_dict.bin' ,userdic='user_dic.tsv'): # userdic 인자에는 사용자 정의 사전 파일 경로 입력가능
        # 단어 인덱스 사전 불러오기
        if(word2index_dic != ''):
